...
class ListPresidenAdapter (private val ListPresidenri: Context, private val presiden : ArrayList<Presiden>, private val listener: (Presiden) -> Unit)
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(LayoutInflater.from(ListPresidenri).inflate(R.layout.item_presiden, parent, false))
    }
